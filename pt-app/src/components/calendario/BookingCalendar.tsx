...
import { createBooking, cancelBooking } from '@/app/calendario/actions'
...
export default function BookingCalendar({
  ...
  return (
    <div className="space-y-8">
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="block text-[10px] opacity-70">
                          {full ? 'Completo' : `${left} ${left === 1 ? 'posto' : 'posti'}`}
                        </span>
                      </button>
                    )
                  })}
      ...
      {/* Le mie prenotazioni */}
      <div>
        <h3 className="text-xl font-bold text-white mb-4">Le mie prenotazioni</h3>
        {myBookings.length === 0 ? (
